...
if(isset($_REQUEST['submit'])){
	...
	if($obj->Insert("sidebar","name='$name',content ='$content', status='$status'")){
		
		header("location:view_sidebar.php");
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <form role="form" action="add_sidebar.php" method="post">
                                <div class="col-lg-12">
                                    <div class="col-lg-6">
