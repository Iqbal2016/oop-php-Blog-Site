...
if(isset($_REQUEST['submit'])){
	...
	if($obj->Update("students","name='$name',email='$email',mobile='$mobile',address='$address'","student_id=$student_id")){
		...
		$msg="<span class='text-warning'>Update Fail!</span>";	
	}
	
}
if(isset($_REQUEST['edit_id'])){
	$student_id=$_REQUEST['edit_id'];
	extract($obj->getById("students","*","student_id=$student_id"));
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Student Forms</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="<?php echo $father; ?>" name="father" required="required">
                                           
                                        </div>
                                        <div class="form-group">
                                            <label>Mother's Name</label>
                                            <input class="form-control" name="mother" value="<?php echo $mother; ?>" required="required">
